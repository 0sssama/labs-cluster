      ...
      <div className="Navigation-right w-full md:w-auto flex items-center gap-x-6">
        ...
        >
          <input
            ...
            checked={!darkLogo}
            onChange={() => {
              Cookies.set("darkMode", darkLogo);
              document.querySelector("html").classList.toggle("dark");
              setDarkLogo(!darkLogo);
            }}
          />
          <div className="w-11 h-6 p-1 bg-gray-300 dark:bg-gray-700 absolute peer:border-transparent peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 dark:border-gray-600 peer-checked:bg-sky-600"></div>
          <span className="ml-16 text-sm font-medium text-gray-900 dark:text-gray-300">
            Dark Mode
          </span>
        </label>
        <input
